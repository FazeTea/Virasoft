...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 border-red-500 "
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px] cursor-pointer ">
      <div
        style={{
      ...
      >
        ...
        <a href="https://www.facebook.com/delivery.zippy" target="_blank">
          <Image
            src={src as string}
            alt="Virasoft LLC"
            fill
